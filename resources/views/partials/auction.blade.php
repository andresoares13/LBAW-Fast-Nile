...
<div id="auctionCard" class="card mb-3">
  ...
  <img  src= "{{asset('img/car/' . $auction->getCarPicture($auction->id))}}" class="d-block user-select-none" width="100%" height="200" aria-label="Placeholder: Image cap" focusable="false" role="img" preserveAspectRatio="xMidYMid slice" viewBox="0 0 318 180" style="font-size:1.125rem;text-anchor:middle;padding: 3%;border-radius: 16px;">
